...
const upcomingClasses: ClassEvent[] = [
  ...
  {
    id: "5",
    course: "CS501: Software Engineering",
    day: "Thursday",
    startTime: "11:00",
    endTime: "12:30",
    location: "Hall A-201",
...
// Helper to get current day's classes
const getTodaysClasses = () => {
  const days = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
  const today = days[new Date().getDay()];
  return upcomingClasses.filter((c) => c.day === today);
};
...
export default function StudentSchedule({ daily = false }: StudentScheduleProps) {
